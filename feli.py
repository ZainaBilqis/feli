...
feature2 = st.number_input('Price', step=0.01, format="%.2f")  # Mengatur step dan format untuk bilangan desimal

# Membuat prediksi berdasarkan input user
if st.button('Prediksi'):
    prediksi_profit = decision_tree.predict([[feature1_numerik, feature2]])  # Mengonversi hasil prediksi menjadi integer
    st.write(f'Prediksi Profit: {prediksi_profit[0]}')  # Menampilkan hasil prediksi